...
xxr.12SV5 <- custom_rarefaction_2(phylist3d, sample_size = 10000, replicates = rarefaction_reps, myseed = seed)


#Check rarefaction, CHANGE THIS LINE BY OBJECT ####
physeq_obj <- phy_deco_PITS
physeq_obj_rare <- phylist3dr$`12SV5`
